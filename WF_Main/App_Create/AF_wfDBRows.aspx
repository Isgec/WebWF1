<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_wfDBRows.aspx.vb" Inherits="AF_wfDBRows" title="Add: DB Rows" %>
...
<asp:Content ID="CPHwfDBRows" ContentPlaceHolderID="cph1" runat="Server">
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelwfDBRows" runat="server" Text="&nbsp;Add: DB Rows"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
      <asp:UpdatePanel ID="UPNLwfDBRows" runat="server">
        <ContentTemplate>
          <LGM:ToolBar0
            ...
            ToolType="lgNMAdd"
            InsertAndStay="False"
            AfterInsertURL="~/WF_Main/App_Edit/EF_wfDBRows.aspx"
          ...
          <asp:FormView ID="FVwfDBRows"
            ...
            <InsertItemTemplate>
              <div id="frmdiv" class="ui-widget-content minipage">
                <asp:Label ID="L_ErrMsgwfDBRows" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
                <table style="margin: auto; border: solid 1pt lightgrey">
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_DashboardID" ForeColor="#CC6633" runat="server" Text="Dashboard ID :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
                      <asp:TextBox
                        ID="F_DashboardID"
                        ...
                        ValidationGroup="wfDBRows"
                        onblur="script_wfDBRows.validate_DashboardID(this);"
                        runat="Server" />
                      ...
                      <AJX:AutoCompleteExtender
                        ...
                        OnClientItemSelected="script_wfDBRows.ACEDashboardID_Selected"
                        OnClientPopulating="script_wfDBRows.ACEDashboardID_Populating"
                        OnClientPopulated="script_wfDBRows.ACEDashboardID_Populated"
                    ...
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_DBRows" ForeColor="#CC6633" runat="server" Text="DB Rows :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
                      <asp:TextBox ID="F_DBRows" Enabled="False" CssClass="mypktxt" Width="88px" runat="server" Text="0" />
                    </td>
                  </tr>
                  <tr>
                    <td class="alignright">
      ...
      <asp:ObjectDataSource
        ...
        InsertMethod="UZ_wfDBRowsInsert"
