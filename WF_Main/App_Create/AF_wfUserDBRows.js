...
var script_wfUserDBRows = {
    ...
    validate_UserID: function(sender) {
      ...
      this.validated_FK_WF_UserDBRows_UserID_main = true;
      this.validate_FK_WF_UserDBRows_UserID(sender,Prefix);
      },
    validate_DashboardID: function(sender) {
      var Prefix = sender.id.replace('DashboardID','');
      this.validated_FK_WF_UserDBRows_UserDashboard_main = true;
      this.validate_FK_WF_UserDBRows_UserDashboard(sender,Prefix);
      },
    validate_DBRows: function(sender) {
      var Prefix = sender.id.replace('DBRows','');
      this.validated_FK_WF_UserDBRows_DBRows_main = true;
      this.validate_FK_WF_UserDBRows_DBRows(sender,Prefix);
      },
    ...
    validate_FK_WF_UserDBRows_UserID: function(o,Prefix) {
      var value = o.id;
      var UserID = $get(Prefix + 'UserID');
      if(UserID.value==''){
        if(this.validated_FK_WF_UserDBRows_UserID_main){
      ...
      value = value + ',' + UserID.value ;
        ...
        PageMethods.validate_FK_WF_UserDBRows_UserID(value, this.validated_FK_WF_UserDBRows_UserID);
      },
    validated_FK_WF_UserDBRows_UserID_main: false,
    validated_FK_WF_UserDBRows_UserID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_wfUserDBRows.validated_FK_WF_UserDBRows_UserID_main){
    ...
    validate_FK_WF_UserDBRows_DBRows: function(o,Prefix) {
      var value = o.id;
      var DashboardID = $get(Prefix + 'DashboardID');
      if(DashboardID.value==''){
        if(this.validated_FK_WF_UserDBRows_DBRows_main){
      ...
      value = value + ',' + DBRows.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_WF_UserDBRows_DBRows(value, this.validated_FK_WF_UserDBRows_DBRows);
      },
    validated_FK_WF_UserDBRows_DBRows_main: false,
    validated_FK_WF_UserDBRows_DBRows: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_wfUserDBRows.validated_FK_WF_UserDBRows_DBRows_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_WF_UserDBRows_UserDashboard: function(o,Prefix) {
      var value = o.id;
      var UserID = $get(Prefix + 'UserID');
      if(UserID.value==''){
        if(this.validated_FK_WF_UserDBRows_UserDashboard_main){
          var o_d = $get(Prefix + 'UserID' + '_Display');
          try{o_d.innerHTML = '';}catch(ex){}
        }
        return true;
      ...
      value = value + ',' + DashboardID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_WF_UserDBRows_UserDashboard(value, this.validated_FK_WF_UserDBRows_UserDashboard);
      },
    validated_FK_WF_UserDBRows_UserDashboard_main: false,
    validated_FK_WF_UserDBRows_UserDashboard: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_wfUserDBRows.validated_FK_WF_UserDBRows_UserDashboard_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
